...
urlpatterns = [
    ...
    path('profile/<int:pk_username>', views.profile_pk, name='users-profile-pk'),
    path('image_get/<int:pk_username>', views.image_get, name='users-img'),

    path('send_message_on_profile/<int:pk_username>', views.send_message_on_profile, name='send-message-on-profile'),
    path('chat/<int:pk_username>', views.chat, name='chat'),
